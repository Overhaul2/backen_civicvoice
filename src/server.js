...
const { anchorClosedConsultations } = require('./controllers/consultController');
const createAdmin = require("../src/services/createAdmin");
...
cron.schedule('1 0 * * *', async () => {
  console.log('--- Vérification des consultations à ancrer ---');

  await anchorClosedConsultations();
});
